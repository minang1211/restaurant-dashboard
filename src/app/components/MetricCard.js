...
export default function MetricCard({ title, value }) {
    return (
        <div className="bg-[#0f1d32] rounded-[2rem] p-6 shadow-sm flex flex-col items-center justify-center relative h-48 transition-transform hover:scale-105 duration-200 border border-[#1a2d4a]">
