        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl p-8 text-center flex flex-col items-center">
                    <Ticket size={32} className="text-[#0f1d32] mb-4" />
                    <h3 className="text-xl font-bold text-[#0f1d32] mb-3">Submit a Ticket</h3>
                    <p className="text-gray-500 text-sm mb-6">
                        For non-urgent issues, please submit a ticket to our support team, we are happy to assist you.
                    </p>
                    <button className="bg-[#0f1d32] text-white font-bold text-sm px-6 py-2.5 rounded-full hover:bg-[#f97316] transition-colors mt-auto">
                        Ticket Support Coming Soon!
                    </button>
                </div>

                <div className="bg-white rounded-2xl p-8 text-center flex flex-col items-center">
                    <Mail size={32} className="text-[#0f1d32] mb-4" />
                    <h3 className="text-xl font-bold text-[#0f1d32] mb-3">Email Us</h3>
                    <p className="text-gray-500 text-sm mb-6">
                    ...
                    <a
                        ...
                        className="bg-[#0f1d32] text-white font-bold text-sm px-6 py-2.5 rounded-full hover:bg-[#f97316] transition-colors mt-auto"
                    >
                ...
                <div className="bg-white rounded-2xl p-8 text-center flex flex-col items-center">
                    <Phone size={32} className="text-[#0f1d32] mb-4" />
                    <h3 className="text-xl font-bold text-[#0f1d32] mb-3">Call Us (Urgent Only)</h3>
                    <p className="text-gray-500 text-sm mb-6">
