...
function getFilteredLogs(callLogs, filter, customStart, customEnd) {
...
export default function OverviewTab() {
    ...
    const filtered = getFilteredLogs(callLogs, filter, customStart, customEnd);
                            ...
                            <div className="absolute right-0 mt-2 w-56 bg-[#0A2342] border border-[#1a2d4a] rounded-lg shadow-lg z-50 overflow-hidden">
                                {filterOptions.map((option) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2.5 text-sm font-bold transition-colors ${filter === option ? "bg-[#FF5900] text-white" : "text-gray-300 hover:bg-[#1a2d4a] hover:text-[#FF5900]"
                                            }`}
                                    >
                                        {option}
                                    </button>
